    ...
    return (
        <div className={classData}>
            ...
            <div>
                ...
                <p>This is a little document I put together to help my clasmates using Git and Github. I hope it can be useful for others too. <span className="copyright">It's free to use and distribute as you please, but I would appreciate if you keep the contributions in any copies you distribute.</span></p>
