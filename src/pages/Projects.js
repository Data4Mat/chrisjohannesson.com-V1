  ...
  <article id="projects">
    ...
    <section>
      ...
      <div className="card">
        ...
        <p>
          This was the website I used to promote myself as musician in the early 2000&apos;s. For those of you who remember the browser wars of the day this
          {' '}
          <a href="https://github.com/ChrisJohDev/chris-maverick-website/blob/main/cgi-bin/chrisHome.cgi">CGI</a>
          {' '}
          script migth bring back some memories or nervous sweating. :-) This too was heavily dependent on the server side for creating the webpages. The server also here was written in Perl.
        </p>
        <p>
      ...
      <ul>
        <li>
          <div id="ref-1">
            <span>[1]</span>
            <span>
              <a href="https://en.wikipedia.org/wiki/Sokoban" target="_blank" rel="noreferrer">
